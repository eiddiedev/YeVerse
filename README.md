...
| II | **Timeline** | Basically done | 10 eras, bilingual, album cross-links — content can be expanded |
| III | **Discography** | Basically done | 17 albums, 3D shelf, Spotify playback, ratings, transitions — polish ongoing |
...
|------|------|------|------|
| I | **Hero** | 已完成 | 签名与引言落地页 |
| II | **Timeline** | 基本完成 | 10 个时代节点，双语，可跳转专辑 — 内容可扩展 |
| III | **Discography** | 基本完成 | 17 张专辑，3D 陈列架，Spotify 播放，评分系统，电影级转场 — 持续打磨中 |
